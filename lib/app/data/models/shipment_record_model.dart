...
//
//     final shipmentRecordModel = shipmentRecordModelFromJson(jsonString);

import 'dart:convert';

ShipmentRecordModel shipmentRecordModelFromJson(String str) =>
    ShipmentRecordModel.fromJson(json.decode(str));

String shipmentRecordModelToJson(ShipmentRecordModel data) =>
...
class ShipmentRecordModel {
  ...
  ShipmentRecordModel({
    this.status,
    this.message,
    this.shipmentRecordList,
  });

  factory ShipmentRecordModel.fromJson(Map<String, dynamic> json) =>
      ShipmentRecordModel(
        status: json["status"],
        message: json["message"],
        shipmentRecordList: json["Shipment"] == null
            ? null
            : ShipmentRecordList.fromJson(json["Shipment"]),
      );

  Map<String, dynamic> toJson() => {
        "status": status,
        "message": message,
        "Shipment": shipmentRecordList?.toJson(),
      };
}
...
class ShipmentRecordList {
  ...
  factory ShipmentRecordList.fromJson(Map<String, dynamic> json) =>
      ShipmentRecordList(
        sId: json["s_Id"],
