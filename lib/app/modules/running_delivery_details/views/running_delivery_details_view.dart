        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            ...
            children: [
              ...
              // Obx(
              //   () {
              //     final sender = controller.senderData;
              //     final receiver = controller.receiverData;
              //     final status = controller.trackingStatus;
              //     if (controller.isTrackingLoading.value == Status.loading) {
              //       return Center(
              //         child: CircularProgressIndicator.adaptive(),
              //       );
              //     }
              //     if (controller.trackingStatus.isEmpty ||
              //         controller.senderData.isEmpty ||
              //         controller.receiverData.isEmpty) {
              //       return Center(child: Text("No tracking data available"));
              //     } else if (controller.isTrackingLoading.value == Status.error) {
              //       return Text('No Data');
              //     } else if (controller.isTrackingLoading.value ==
              //         Status.success) {
              //       final status = controller.trackingStatus[0];
              //       final sender = controller.senderData[0];
              //       final receiver = controller.receiverData[0];
